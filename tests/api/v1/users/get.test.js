...
describe("GET /api/v1/users", () => {
  describe("Usuario autenticado", () => {
    ...
    test("Busca todos os registros com paginação por Perfil_ID", async () => {
      const user = await orchestrator.createUser({
        nome: "ADMINISTRADOR",
      });
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users?page=1&limit=10&perfil_id=2",
        {
          method: "GET",
          headers: {
            "Content-type": "application/json",
    ...
    test("Busca os registros com paginação pelo nome", async () => {
      const user = await orchestrator.createUser({
        nome: "ADMINISTRADOR",
      });
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users?page=1&limit=10&search=KAYLA",
        {
          method: "GET",
          headers: {
            "Content-type": "application/json",
    ...
    test("Busca os registros com paginação pelo email", async () => {
      const user = await orchestrator.createUser({
        nome: "ADMINISTRADOR",
        email: "luiscla@exemplo.com",
      });

      const user2 = await orchestrator.createUser({
        nome: "KAYLANY",
        perfil_id: 2,
        email: "kaycla@exemplo.com",
      });

      const session = await orchestrator.createSession(user.id);

      const response = await fetch(
        "http://localhost:3000/api/v1/users?page=1&limit=10&search=luiscla",
        {
          method: "GET",
          headers: {
            "Content-type": "application/json",
    ...
    test("Busca os registros com querys invalidas", async () => {
      const user = await orchestrator.createUser({
        nome: "ADMINISTRADOR",
        email: "luiscla@exemplo.com",
      });
      ...
      const response = await fetch(
        "http://localhost:3000/api/v1/users?page=k&limit=oi&search=luiscla",
        {
          method: "GET",
          headers: {
            "Content-type": "application/json",
